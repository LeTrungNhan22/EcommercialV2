...
const OrderList = ({ userId }) => {
    ...
    const orderFilter = useSelector(state => state.order.orderFilter.resultList);
    ...
    useEffect(() => {
        const getOrderDetail = async () => {
            ...
            if (res.meta.requestStatus === "fulfilled") {
                const res2 = await dispatch(orderDetailById(res.payload.resultList[0].id));
            }
        }
        if (userId) getOrderDetail();
    }, [userId])
                    ...
                    <ul className="mt-5 divide-y space-y-3">
                        <li className="px-4 py-5 duration-150 hover:border-white hover:rounded-xl hover:bg-gray-100">
                            <div className="flex items-center justify-between pb-3">
                                <div class="border border-blue-200 shadow rounded-md p-4  w-full mx-auto">
                                        ...
                                        <div class="flex-1 space-y-6 py-1">
                                            ...
                                            <div class="space-y-3">
                                                <div class="grid grid-cols-3 gap-4">
                                                    <div class="h-2  bg-slate-400rounded col-span-2"></div>
